...
document.addEventListener('DOMContentLoaded', () => {
    document.getElementById("streamButton").addEventListener('change', function () {
        scene.showStreamlines = this.checked;
    });

    document.getElementById("velocityButton").addEventListener('change', function () {
        scene.showVelocities = this.checked;
    });

    document.getElementById("pressureButton").addEventListener('change', function () {
        scene.showPressure = this.checked;
    });

    document.getElementById("smokeButton").addEventListener('change', function () {
        scene.showSmoke = this.checked;
    });

    document.getElementById("overrelaxButton").addEventListener('change', function () {
